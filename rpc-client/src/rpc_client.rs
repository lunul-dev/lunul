...
#[allow(deprecated)]
use lunul_rpc_client_api::deprecated_config::{
...
/// documentation.
///
/// [`Finalized`]: lunul_sdk::commitment_config::CommitmentLevel::Finalized
/// [`Processed`]: lunul_sdk::commitment_config::CommitmentLevel::Processed
/// [jsonprot]: https://lunul.com/docs/rpc
/// [JSON-RPC]: https://www.jsonrpc.org/specification
/// [slots]: https://lunul.com/docs/terminology#slot
/// [cl]: https://lunul.com/docs/rpc#configuring-state-commitment
///
/// # Errors
///
/// Methods on `RpcClient` return
/// [`client_error::Result`][lunul_rpc_client_api::client_error::Result], and many of them
/// return the [`RpcResult`][lunul_rpc_client_api::response::RpcResult] typedef, which
/// contains [`Response<T>`][lunul_rpc_client_api::response::Response] on `Ok`. Both
/// `client_error::Result` and [`RpcResult`] contain `ClientError` on error. In
/// the case of `RpcResult`, the actual return value is in the
/// [`value`][lunul_rpc_client_api::response::Response::value] field, with RPC contextual
/// information in the [`context`][lunul_rpc_client_api::response::Response::context]
/// field, so it is common for the value to be accessed with `?.value`, as in
///
/// ```
/// # use lunul_sdk::system_transaction;
/// # use lunul_rpc_client_api::client_error::Error;
/// # use lunul_rpc_client::rpc_client::RpcClient;
/// # use lunul_sdk::signature::{Keypair, Signer};
/// # use lunul_sdk::hash::Hash;
/// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
/// # let key = Keypair::new();
/// # let to = lunul_sdk::pubkey::new_rand();
/// # let lamports = 50;
...
/// [`reqwest::Error`](lunul_rpc_client_api::client_error::reqwest::Error)s
/// [`is_timeout`](lunul_rpc_client_api::client_error::reqwest::Error::is_timeout) method
...
///
/// [`ClientError`]: lunul_rpc_client_api::client_error::Error
/// [`ClientErrorKind`]: lunul_rpc_client_api::client_error::ErrorKind
/// [`ClientErrorKind::Reqwest`]: lunul_rpc_client_api::client_error::ErrorKind::Reqwest
...
impl RpcClient {
    ...
    ///
    /// [`CommitmentLevel`]: lunul_sdk::commitment_config::CommitmentLevel
    ///
    /// # Examples
    ///
    /// ```
    /// # use lunul_sdk::commitment_config::CommitmentConfig;
    /// # use lunul_rpc_client::rpc_client::RpcClient;
    /// let url = "http://localhost:8899".to_string();
    ...
    ///
    /// [`RpcError`]: lunul_rpc_client_api::request::RpcError
    /// [`RpcResponseError`]: lunul_rpc_client_api::request::RpcError::RpcResponseError
    /// [`JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE`]: lunul_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE`]: lunul_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY`]: lunul_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`sendTransaction`]: https://lunul.com/docs/rpc/http/sendtransaction
    /// [`getLatestBlockhash`]: https://lunul.com/docs/rpc/http/getlatestblockhash
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`skip_preflight`]: lunul_rpc_client_api::config::RpcSendTransactionConfig::skip_preflight
    /// [`RpcSendTransactionConfig`]: lunul_rpc_client_api::config::RpcSendTransactionConfig
    ...
    ///
    /// [`getSignatureStatuses`]: https://lunul.com/docs/rpc/http/getsignaturestatuses
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`err`]: lunul_rpc_client_api::response::RpcSimulateTransactionResult::err
    /// [`logs`]: lunul_rpc_client_api::response::RpcSimulateTransactionResult::logs
    ///
    /// Simulating a transaction is similar to the ["preflight check"] that is
    /// run by default when sending a transaction.
    ///
    /// ["preflight check"]: https://lunul.com/docs/rpc/http/sendtransaction
    ///
    ...
    /// [`sig_verify`]: lunul_rpc_client_api::config::RpcSimulateTransactionConfig::sig_verify
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ///
    /// [`simulateTransaction`]: https://lunul.com/docs/rpc/http/simulatetransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`accounts`]: lunul_rpc_client_api::config::RpcSimulateTransactionConfig::accounts
    /// [accounts2]: lunul_rpc_client_api::response::RpcSimulateTransactionResult::accounts
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ...
    ///
    /// [`getHighestSnapshotSlot`]: https://lunul.com/docs/rpc/http/gethighestsnapshotslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`TransactionError`]: lunul_sdk::transaction::TransactionError
    ///
    /// This function only searches a node's recent history, including all
    /// recent slots, plus up to
    /// [`MAX_RECENT_BLOCKHASHES`][lunul_sdk::clock::MAX_RECENT_BLOCKHASHES]
    ...
    ///
    /// [`getSlot`]: https://lunul.com/docs/rpc/http/getslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockHeight`]: https://lunul.com/docs/rpc/http/getblockheight
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSlotLeaders`]: https://lunul.com/docs/rpc/http/getslotleaders
    ///
    /// # Examples
    ///
    /// ```
    /// # use lunul_rpc_client_api::client_error::Error;
    /// # use lunul_rpc_client::rpc_client::RpcClient;
    /// # use lunul_sdk::slot_history::Slot;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// let start_slot = 1;
    /// let limit = 3;
    ...
    ///
    /// [`getBlockProduction`]: https://lunul.com/docs/rpc/http/getblockproduction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getStakeActivation`]: https://lunul.com/docs/rpc/http/getstakeactivation
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSupply`]: https://lunul.com/docs/rpc/http/getsupply
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getLargestAccounts`]: https://lunul.com/docs/rpc/http/getlargestaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getVoteAccounts`]: https://lunul.com/docs/rpc/http/getvoteaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getClusterNodes`]: https://lunul.com/docs/rpc/http/getclusternodes
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getBlock`]: https://lunul.com/docs/rpc/http/getblock
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// # use lunul_rpc_client_api::client_error::Error;
    /// # use lunul_rpc_client::rpc_client::RpcClient;
    /// # use lunul_transaction_status::UiTransactionEncoding;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let slot = rpc_client.get_slot()?;
    ...
    ///
    /// [`getBlocks`]: https://lunul.com/docs/rpc/http/getblocks
    /// [`getConfirmedBlocks`]: https://lunul.com/docs/rpc/deprecated/getconfirmedblocks
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`Confirmed`].
    ///
    /// [`Confirmed`]: lunul_sdk::commitment_config::CommitmentLevel::Confirmed
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getBlocks`] RPC method, unless
    ...
    ///
    /// [`getBlocksWithLimit`]: https://lunul.com/docs/rpc/http/getblockswithlimit
    /// [`getConfirmedBlocksWithLimit`]: https://lunul.com/docs/rpc/deprecated/getconfirmedblockswithlimit
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getSignaturesForAddress`]: https://lunul.com/docs/rpc/http/getsignaturesforaddress
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
    /// # use lunul_rpc_client_api::client_error::Error;
    /// # use lunul_rpc_client::rpc_client::{GetConfirmedSignaturesForAddress2Config, RpcClient};
    /// # use lunul_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     system_transaction,
    ...
    ///
    /// [`getTransaction`]: https://lunul.com/docs/rpc/http/gettransaction
    /// [`getConfirmedTransaction`]: https://lunul.com/docs/rpc/deprecated/getConfirmedTransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockTime`]: https://lunul.com/docs/rpc/http/getblocktime
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochInfo`]: https://lunul.com/docs/rpc/http/getepochinfo
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getLeaderSchedule`]: https://lunul.com/docs/rpc/http/getleaderschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochSchedule`]: https://lunul.com/docs/rpc/http/getepochschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPerformanceSamples`]: https://lunul.com/docs/rpc/http/getrecentperformancesamples
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPrioritizationFees`]: https://lunul.com/docs/rpc/http/getrecentprioritizationfees
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getIdentity`]: https://lunul.com/docs/rpc/http/getidentity
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getInflationGovernor`]: https://lunul.com/docs/rpc/http/getinflationgovernor
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationRate`]: https://lunul.com/docs/rpc/http/getinflationrate
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationReward`]: https://lunul.com/docs/rpc/http/getinflationreward
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getVersion`]: https://lunul.com/docs/rpc/http/getversion
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// let version = semver::Version::parse(&version.lunul_core)?;
    ...
    /// method.
    ///
    /// [`minimumLedgerSlot`]: https://lunul.com/docs/rpc/http/minimumledgerslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`RpcError::ForUser`]: lunul_rpc_client_api::request::RpcError::ForUser
    ...
    ///
    /// [`getAccountInfo`]: https://lunul.com/docs/rpc/http/getaccountinfo
    ///
    /// # Examples
    ///
    /// ```
    /// # use lunul_rpc_client_api::client_error::Error;
    /// # use lunul_rpc_client::rpc_client::{self, RpcClient};
    /// # use lunul_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use lunul_account_decoder::UiAccountEncoding;
    /// # use std::str::FromStr;
    /// # let mocks = rpc_client::create_rpc_client_mocks();
    /// # let rpc_client = RpcClient::new_mock_with_mocks("succeeds".to_string(), mocks);
    /// let alice_pubkey = Pubkey::from_str("BgvYtJEfmZYdVKiptmMjxGzv8iQoo4MWjsP3QsTkhhxa").unwrap();
    ...
    /// method.
    ///
    /// [`getMaxRetransmitSlot`]: https://lunul.com/docs/rpc/http/getmaxretransmitslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Get the max slot seen from after [shred](https://lunul.com/docs/terminology#shred) insert.
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`getMaxShredInsertSlot`]: https://lunul.com/docs/rpc/http/getmaxshredinsertslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMultipleAccounts`]: https://lunul.com/docs/rpc/http/getmultipleaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMinimumBalanceForRentExemption`]: https://lunul.com/docs/rpc/http/getminimumbalanceforrentexemption
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBalance`]: https://lunul.com/docs/rpc/http/getbalance
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getProgramAccounts`]: https://lunul.com/docs/rpc/http/getprogramaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use lunul_account_decoder::{UiDataSliceConfig, UiAccountEncoding};
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let alice = Keypair::new();
    /// # let base64_bytes = "\
    ...
    ///
    /// [`getStakeMinimumDelegation`]: https://lunul.com/docs/rpc/http/getstakeminimumdelegation
    ///
    /// # Examples
    ///
    /// ```
...
mod tests {
    use {
        ...
        lunul_rpc_client_api::client_error::ErrorKind,
        lunul_sdk::{
