...
COMPILER_RT_DIR = $(LOCAL_PATH)../dependencies/platform-tools/rust/lib/rustlib/sbf-lunul-lunul/lib
...
ifeq (,$(wildcard $(subst .so,-keypair.json,$1)))
	$(_@)lunul-keygen new --no-passphrase --silent -o $(subst .so,-keypair.json,$1)
endif
	@echo To deploy this program:
	@echo $$$$ lunul program deploy $(abspath $1)
endef
