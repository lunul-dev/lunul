...
//! proposal][ccf].
//!
//! [`getFeeForMessage`]: https://lunul.com/docs/rpc/http/getfeeformessage
//! [ccf]: https://docs.lunullabs.com/proposals/comprehensive-compute-fees
//!
//! See also the Solana [documentation on the fees sysvar][sdoc].
//!
//! [sdoc]: https://docs.lunullabs.com/runtime/sysvars#fees
