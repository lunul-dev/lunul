...
//!
//! [rent]: https://docs.lunullabs.com/implemented-proposals/rent
//!
...
//!
//! [sdoc]: https://docs.lunullabs.com/runtime/sysvars#rent
//!
//! # Examples
//!
...
//! }
//! #
//! # use lunul_program::sysvar::SysvarId;
//! # let p = Rent::id();
//! # let l = &mut 1009200;
...
//! # use lunul_sdk::sysvar::rent::{self, Rent};
//! # use anyhow::Result;
//! #
