...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`lunul_sdk`], [`lunul_rpc_client`] and [`anyhow`] crates.
    ///
    ...
    ///
    /// [nonced transaction]: https://docs.lunullabs.com/implemented-proposals/durable-tx-nonces
    ///
    ...
    ///
    /// [`lunul_sdk`]: https://docs.rs/lunul-sdk
    /// [`lunul_rpc_client`]: https://docs.rs/lunul-client
    /// [`anyhow`]: https://docs.rs/anyhow
    ///
    /// ```
    /// # use lunul_program::example_mocks::lunul_sdk;
    ...
    pub fn hash_raw_message(message_bytes: &[u8]) -> Hash {
        ...
        hasher.update(b"lunul-tx-message-v1");
...
mod tests {
    ...
    fn test_message_hash() {
        ...
        // in this case, the domain prefix `lunul-tx-message-v1` should be updated.
