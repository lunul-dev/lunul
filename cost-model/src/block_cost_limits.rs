...
/// is currently publicly communicated on lunul.com
pub const MAX_BLOCK_REPLAY_TIME_US: u64 = 400_000;
/// number of concurrent processes,
pub const MAX_CONCURRENCY: u64 = 4;

// Cluster data, method of collecting at https://github.com/lunul-labs/lunul/issues/19627
// Dashboard: https://metrics.lunul.com/d/monitor-edge/cluster-telemetry?orgId=1
...
lazy_static! {
    ...
    pub static ref BUILT_IN_INSTRUCTION_COSTS: HashMap<Pubkey, u64> = [
        (lunul_stake_program::id(), lunul_stake_program::stake_instruction::DEFAULT_COMPUTE_UNITS),
        (lunul_config_program::id(), lunul_config_program::config_processor::DEFAULT_COMPUTE_UNITS),
        (lunul_vote_program::id(), lunul_vote_program::vote_processor::DEFAULT_COMPUTE_UNITS),
        (lunul_system_program::id(), lunul_system_program::system_processor::DEFAULT_COMPUTE_UNITS),
        (compute_budget::id(), lunul_compute_budget_program::DEFAULT_COMPUTE_UNITS),
        (address_lookup_table::program::id(), lunul_address_lookup_table_program::processor::DEFAULT_COMPUTE_UNITS),
        (bpf_loader_upgradeable::id(), lunul_bpf_loader_program::UPGRADEABLE_LOADER_COMPUTE_UNITS),
        (bpf_loader_deprecated::id(), lunul_bpf_loader_program::DEPRECATED_LOADER_COMPUTE_UNITS),
        (bpf_loader::id(), lunul_bpf_loader_program::DEFAULT_LOADER_COMPUTE_UNITS),
        (loader_v4::id(), lunul_loader_v4_program::DEFAULT_COMPUTE_UNITS),
