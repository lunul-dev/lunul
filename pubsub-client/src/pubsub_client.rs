...
//! subscriptions][spec].
//!
//! [spec]: https://lunul.com/docs/rpc/websocket
//!
...
//! `--rpc-pubsub-enable-vote-subscription` to `lunul-validator`. When these
//! methods are disabled, the RPC server will return a "Method not found" error
//! message.
//!
//! [`block_subscribe`]: https://docs.rs/lunul-rpc/latest/lunul_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.block_subscribe
//! [`vote_subscribe`]: https://docs.rs/lunul-rpc/latest/lunul_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.vote_subscribe
//!
//! # Examples
//!
...
//! use lunul_pubsub_client::pubsub_client::PubsubClient;
//! use lunul_rpc_client_api::config::RpcAccountInfoConfig;
//! use lunul_sdk::pubkey::Pubkey;
//! use std::thread;
//!
//! fn get_account_updates(account_pubkey: Pubkey) -> Result<()> {
//!     let url = "wss://api.devnet.lunul.com/";
//!
...
//! }
//! #
//! # get_account_updates(lunul_sdk::pubkey::new_rand());
//! # Ok::<(), anyhow::Error>(())
//! ```
...
use {
    ...
    lunul_account_decoder::UiAccount,
    ...
    lunul_sdk::{clock::Slot, pubkey::Pubkey, signature::Signature},
    std::{
        marker::PhantomData,
        net::TcpStream,
        sync::{
    ...
    fn get_version(
        ...
        if let Ok(json_msg) = serde_json::from_str::<Map<String, Value>>(message_text) {
            if let Some(Object(version_map)) = json_msg.get("result") {
                if let Some(node_version) = version_map.get("lunul-core") {
...
impl PubsubClient {
    ...
    ///
    /// [`accountSubscribe`]: https://lunul.com/docs/rpc/websocket/accountsubscribe
    ...
    /// `--rpc-pubsub-enable-block-subscription` to `lunul-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`blockSubscribe`] RPC method.
    ///
    /// [`blockSubscribe`]: https://lunul.com/docs/rpc/websocket/blocksubscribe
    ...
    ///
    /// [`logsSubscribe`]: https://lunul.com/docs/rpc/websocket/logssubscribe
    ...
    ///
    /// [`programSubscribe`]: https://lunul.com/docs/rpc/websocket/programsubscribe
    ...
    ///
    /// This method is disabled by default. It can be enabled by passing
    /// `--rpc-pubsub-enable-vote-subscription` to `lunul-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`voteSubscribe`] RPC method.
    ///
    /// [`voteSubscribe`]: https://lunul.com/docs/rpc/websocket/votesubscribe
    ...
    /// validator.
    ///
    /// [root]: https://lunul.com/docs/terminology#root
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`rootSubscribe`] RPC method.
    ///
    /// [`rootSubscribe`]: https://lunul.com/docs/rpc/websocket/rootsubscribe
    ...
    ///
    /// [`signatureSubscribe`]: https://lunul.com/docs/rpc/websocket/signaturesubscribe
    ...
    ///
    /// [`slotSubscribe`]: https://lunul.com/docs/rpc/websocket/slotsubscribe
    ...
    ///
    /// [`slotUpdatesSubscribe`]: https://lunul.com/docs/rpc/websocket/slotsupdatessubscribe
