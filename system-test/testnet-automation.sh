...
#     git clone https://github.com/lunul-labs/testnet-keypairs.git "${REPO_ROOT}"/net/keypairs
    git clone git@github.com:lunul-labs/testnet-keypairs.git "${REPO_ROOT}"/net/keypairs
  ...
  get_net_launch_software_version_launch_args "$CHANNEL" "lunul-release" version_args
...
[[ -n $INFLUX_HOST ]] || INFLUX_HOST=https://internal-metrics.lunul.com:8086
