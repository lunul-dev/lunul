...
testnet participants, [https://lunul.com/discord](https://lunul.com/discord)

## Useful Links & Discussion

- [Network Explorer](http://explorer.lunul.com/)
- [Testnet Metrics Dashboard](https://metrics.lunul.com:3000/d/monitor-edge/cluster-telemetry-edge?refresh=60s&orgId=2)
- Validator [Discord](https://lunul.com/discord) channels
...
- [Core software repo](https://github.com/lunul-labs/lunul)
