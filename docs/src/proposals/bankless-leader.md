...
The [fee account](https://lunul.com/docs/terminology#fee_account) pays for the
...
### Check out the [SIMD here to contribute](https://github.com/lunul-foundation/lunul-improvement-documents/pull/5)
