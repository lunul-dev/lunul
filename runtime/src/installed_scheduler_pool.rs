...
//! actual implementations provided by the dependent crate (`lunul-unified-scheduler-pool`, which
//! in turn depends on `lunul-ledger`, which in turn depends on `lunul-runtime`), avoiding a
//! cyclic dependency.
//!
...
///     end
///
///     subgraph lunul-unified-scheduler-pool
///         SchedulerPool;
///         PooledScheduler;
///         ScheduleExecution(["schedule_execution()"]);
///     end
///
///     subgraph lunul-ledger
