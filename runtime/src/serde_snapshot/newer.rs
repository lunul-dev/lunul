use {
    ...
    lunul_accounts_db::{accounts_hash::AccountsHash, ancestors::AncestorsForSerialization},
    lunul_measure::measure::Measure,
    lunul_sdk::{deserialize_utils::ignore_eof_error, stake::state::Delegation},
...
impl<'a> lunul_frozen_abi::abi_example::IgnoreAsHelper for SerializableVersionedBank<'a> {}
