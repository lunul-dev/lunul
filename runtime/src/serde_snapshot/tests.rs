...
mod serde_snapshot_tests {
        ...
        R: Read,
    {
        ...
        reconstruct_accountsdb_from_fields(
            ...
            false,
            Some(lunul_accounts_db::accounts_db::ACCOUNTS_DB_CONFIG_FOR_TESTING),
            None,
            Arc::default(),
            None,
            (u64::default(), None),
        ...
        F: Fn(AccountsDb, Slot) -> AccountsDb,
    {
        ...
        let pubkey = lunul_sdk::pubkey::new_rand();
        let purged_pubkey1 = lunul_sdk::pubkey::new_rand();
        let purged_pubkey2 = lunul_sdk::pubkey::new_rand();
    ...
    fn test_accounts_purge_long_chained_after_snapshot_restore() {
        ...
        let pubkey = lunul_sdk::pubkey::new_rand();
        let dummy_pubkey = lunul_sdk::pubkey::new_rand();
        let purged_pubkey1 = lunul_sdk::pubkey::new_rand();
        let purged_pubkey2 = lunul_sdk::pubkey::new_rand();
