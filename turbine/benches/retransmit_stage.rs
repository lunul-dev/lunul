...
use {
    ...
    lunul_turbine::retransmit_stage::retransmitter,
    std::{
        iter::repeat_with,
...
// the case since https://github.com/lunul-labs/lunul/pull/17716.
...
fn bench_retransmitter(bencher: &mut Bencher) {
    ...
    let retransmitter_handles = retransmitter(
        ...
        cluster_info,
        shreds_receiver,
        Arc::default(), // lunul_rpc::max_slots::MaxSlots
        None,
    );
