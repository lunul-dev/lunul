use {
    ...
    lunul_runtime::{bank::Bank, epoch_stakes::NodeIdToVoteAccounts},
    lunul_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, lunul_runtime::epoch_stakes::NodeVoteAccounts};
    ...
    fn test_best_peer_2() {
        ...
        let k1 = lunul_sdk::pubkey::new_rand();
        let k2 = lunul_sdk::pubkey::new_rand();
    ...
    fn test_best_completed_slot_peer() {
        ...
        for ci in contact_infos.iter_mut() {
            ci.set_pubkey(lunul_sdk::pubkey::new_rand());
        }
        let slot = 9;
