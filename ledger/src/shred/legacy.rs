use {
    ...
    lunul_perf::packet::deserialize_from_with_limit,
    lunul_sdk::{clock::Slot, signature::Signature},
...
impl<'a> Shred<'a> for ShredData {
    ...
    fn from_payload(mut payload: Vec<u8>) -> Result<Self, Error> {
        ...
        // https://github.com/lunul-labs/lunul/pull/10109
        // https://github.com/lunul-labs/lunul/pull/16602
