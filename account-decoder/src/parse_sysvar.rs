#[allow(deprecated)]
use lunul_sdk::sysvar::{fees::Fees, recent_blockhashes::RecentBlockhashes};
use {
    crate::{
...
mod test {
    #[allow(deprecated)]
    use lunul_sdk::sysvar::recent_blockhashes::IterItem;
    use {
        super::*,
        lunul_sdk::{account::create_account_for_test, fee_calculator::FeeCalculator, hash::Hash},
    };
    ...
    fn test_parse_sysvars() {
        ...
        let bad_pubkey = lunul_sdk::pubkey::new_rand();
