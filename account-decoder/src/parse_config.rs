use {
    ...
    bincode::deserialize,
    serde_json::Value,
    lunul_config_program::{get_config_data, ConfigKeys},
    lunul_sdk::{
        pubkey::Pubkey,
        stake::config::{
...
#[deprecated(
    since = "1.16.7",
    note = "Please use `lunul_sdk::stake::state::warmup_cooldown_rate()` instead"
)]
#[derive(Debug, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
mod test {
    use {
        ...
        lunul_config_program::create_config_account, lunul_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = lunul_sdk::pubkey::new_rand();
