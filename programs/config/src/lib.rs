...
pub use lunul_sdk::config::program::id;
#[allow(deprecated)]
use lunul_sdk::stake::config::Config as StakeConfig;
use {
...
// TODO move ConfigState into `lunul_program` to implement trait locally
#[allow(deprecated)]
