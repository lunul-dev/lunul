...
#[allow(deprecated)]
use lunul_sdk::stake::config;
#[deprecated(
    since = "1.8.0",
    note = "Please use `lunul_sdk::stake::config` or `lunul_program::stake::config` instead"
)]
pub use lunul_sdk::stake::config::*;
use {
    bincode::deserialize,
    lunul_config_program::{create_config_account, get_config_data},
    lunul_sdk::{
